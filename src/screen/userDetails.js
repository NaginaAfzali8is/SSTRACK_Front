...
function UserDetails() {
    ...
    const renderCalendar = () => {
        ...
        // const getAllDaysResponse = getAllDays(); // Call the getAllDays function
        // const totalHoursByDay = getAllDays()?.data?.totalHoursByDay || [];
        // console.log('total day', totalHoursByDay)
        ...
        for (let i = 0; i < daysInMonth; i++) {
            ...
            // Check if the day has total hours greater than 0
            // const dayHasTotalHours = totalHoursByDay.some(day =>
            //     day.date === dayFormatted && day.totalHours !== "0h 0m"
            // );
