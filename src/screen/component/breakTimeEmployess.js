        ...
        try {
            ...
            const formattedBreakTime = (() => {
                ...
                return {
                    ...
                    breakStartTime: start.toISOString(),
                    breakEndTime: end.toISOString(),
                };
            })();
            ...
            const requestData = [
                {
                    userId: employeeId, // Use the current employee ID
                    settings: {
                        breakTime: [formattedBreakTime], // Single break time as an array
