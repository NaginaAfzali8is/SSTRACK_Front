        ...
        <div className="mainwrapper">
          <div className="summaryContainer">
            ...
            {loading ? (
              ...
              // Check userType to determine what to render
              userType === "admin" || userType === "owner" ? (
                // Render for admin and owner
                <>
                  {(userType === "admin" || userType === 'owner') && reportData && reportData.allUsers ? (
                    // Render admin's view with all users' data
                    ...
                    // Render owner's view with their data
                    userType === "owner" && reportData ? (
                      <div className="asadMehmoodDiv">
                        <div>
                          <p><img src={addButton} alt="Add" /><span>{reportData?.employee}</span></p>
                        </div>
                        <div className="durationDiv">
                ...
                userType === 'manager' ? (
                  ...
                  <>
                    ...
                    {reportData ? (
                      // Render manager's view with manager's data
                      reportData.allUsers.map((data, index) => (
                        <div className="asadMehmoodDiv" key={index}>
                          <div>
                            <p><img src={addButton} alt="Add" /><span>{data?.employee}</span></p>
                      ...
                      // Render a message if no data is available for the manager
                  ...
                  <>
                    {reportData ? (
                      // Render user's data if available
                      <div className="asadMehmoodDiv">
                        {reportData.allUsers.map((user, index) => (
                          <>
                            <div key={index}>
                              <p><img src={addButton} alt="Add" /><span>{user.employee}</span></p>
                            </div>
                            <div className="durationDiv">
                              <p>{user.Duration}</p>
                              <p>{Math.floor(user.Activity)} %</p>
                            </div>
                          </>
                        ))}
                      </div>
                    ) : (
                      // Render a message if no data is available for the user
                      <div>No data available</div>
                    )}
                  </>
                ))
